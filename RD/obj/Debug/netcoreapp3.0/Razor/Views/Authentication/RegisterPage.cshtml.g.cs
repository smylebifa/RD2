#pragma checksum "C:\Users\Oleg\source\repos\RD\RD2\RD\Views\Authentication\RegisterPage.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a5fc117f1e045803e3584f4c55428924aac6025b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a5fc117f1e045803e3584f4c55428924aac6025b", @"/Views/Authentication/RegisterPage.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a5fc117f1e045803e3584f4c55428924aac6025b4508", async() => {
                WriteLiteral(@"
...
#nullable disable
 ...
 ");
                ...
                if (login == """") {
                    ...
                    e.preventDefault();
                    $.get(this.href, function (data) {
                        $('#dialogContent').html('<div class=""modal-content""> <div class=""modal-header""><h4>Ошибка</h4><button class=""close"" data-dismiss=""modal"" area-hidden=""true"">x</button></div><div class=""modal-body""> <dl class=""dl-horizontal""> <dt>Ошибка:</dt> <d");
                WriteLiteral(@"d>Для регистрации нужно ввести пароль</dd> </dl> </div> </div>');
                        $('#modDialog').modal('show');
                    });
